...
public static class PuzzleCatalog
{
    ...
    [
        ...
        new(PuzzleKind.Hoshi, "Звезда", "Шесть треугольников 1–9; в линиях по трём направлениям цифры не повторяются, даже через пустой центр", "★"),
        new(PuzzleKind.Killer, "Киллер", "В контуре цифры не повторяются и дают сумму в углу; плюс обычные ряды, столбцы и квадраты 3×3", "Σ")
    ];
